...
foreign import ccall "isl_map_dim" c_dim :: MapRef s_map -> DimType -> IO C.CInt

dim :: MapRef s_map -> DimType -> Int
dim map typ =
    let !r = unsafePerformIO $ fromIntegral <$> c_dim map typ in r


foreign import ccall "isl_map_find_dim_by_id" c_findDimById :: MapRef s_map -> DimType -> IdRef s_id -> IO C.CInt

findDimById :: MapRef s_map -> DimType -> IdRef s_id -> Int
findDimById map typ id =
    let !r = unsafePerformIO $ fromIntegral <$> c_findDimById map typ id in r


foreign import ccall "isl_map_find_dim_by_name" c_findDimByName :: MapRef s_map -> DimType -> C.CString -> IO C.CInt

findDimByName :: MapRef s_map -> DimType -> String -> Int
...
foreign import ccall "isl_map_involves_dims" c_involvesDims :: MapRef s_map -> DimType -> C.CUInt -> C.CUInt -> IO C.CInt

involvesDims :: MapRef s_map -> DimType -> Int -> Int -> Int
involvesDims map typ first n =
    let !r = unsafePerformIO $ fromIntegral <$> c_involvesDims map typ (fromIntegral first) (fromIntegral n) in r


foreign import ccall "isl_map_dump" c_dump :: MapRef s_map -> IO ()

dump :: MapRef s_map -> ()
dump map =
    let !r = unsafePerformIO $ c_dump map in r


foreign import ccall "isl_map_get_dim_name" c_getDimName :: MapRef s_map -> DimType -> C.CUInt -> IO C.CString

getDimName :: MapRef s_map -> DimType -> Int -> String
getDimName map typ pos =
    let !r = unsafePerformIO $ C.peekCString =<< c_getDimName map typ (fromIntegral pos) in r


foreign import ccall "isl_map_get_tuple_name" c_getTupleName :: MapRef s_map -> DimType -> IO C.CString

getTupleName :: MapRef s_map -> DimType -> String
getTupleName map typ =
    let !r = unsafePerformIO $ C.peekCString =<< c_getTupleName map typ in r


foreign import ccall "isl_map_can_curry" c_canCurry :: MapRef s_map -> IO C.CBool

canCurry :: MapRef s_map -> Bool
canCurry map =
    let !r = unsafePerformIO $ M.toBool <$> c_canCurry map in r


foreign import ccall "isl_map_can_range_curry" c_canRangeCurry :: MapRef s_map -> IO C.CBool

canRangeCurry :: MapRef s_map -> Bool
canRangeCurry map =
    let !r = unsafePerformIO $ M.toBool <$> c_canRangeCurry map in r


foreign import ccall "isl_map_can_uncurry" c_canUncurry :: MapRef s_map -> IO C.CBool

canUncurry :: MapRef s_map -> Bool
canUncurry map =
    let !r = unsafePerformIO $ M.toBool <$> c_canUncurry map in r


foreign import ccall "isl_map_can_zip" c_canZip :: MapRef s_map -> IO C.CBool

canZip :: MapRef s_map -> Bool
canZip map =
    let !r = unsafePerformIO $ M.toBool <$> c_canZip map in r


foreign import ccall "isl_map_domain_is_wrapping" c_domainIsWrapping :: MapRef s_map -> IO C.CBool

domainIsWrapping :: MapRef s_map -> Bool
domainIsWrapping map =
    let !r = unsafePerformIO $ M.toBool <$> c_domainIsWrapping map in r


foreign import ccall "isl_map_has_dim_id" c_hasDimId :: MapRef s_map -> DimType -> C.CUInt -> IO C.CBool

hasDimId :: MapRef s_map -> DimType -> Int -> Bool
hasDimId map typ pos =
    let !r = unsafePerformIO $ M.toBool <$> c_hasDimId map typ (fromIntegral pos) in r


foreign import ccall "isl_map_has_dim_name" c_hasDimName :: MapRef s_map -> DimType -> C.CUInt -> IO C.CBool

hasDimName :: MapRef s_map -> DimType -> Int -> Bool
hasDimName map typ pos =
    let !r = unsafePerformIO $ M.toBool <$> c_hasDimName map typ (fromIntegral pos) in r


foreign import ccall "isl_map_has_equal_space" c_hasEqualSpace :: MapRef s_map1 -> MapRef s_map2 -> IO C.CBool

hasEqualSpace :: MapRef s_map1 -> MapRef s_map2 -> Bool
hasEqualSpace map1 map2 =
    let !r = unsafePerformIO $ M.toBool <$> c_hasEqualSpace map1 map2 in r


foreign import ccall "isl_map_has_tuple_id" c_hasTupleId :: MapRef s_map -> DimType -> IO C.CBool

hasTupleId :: MapRef s_map -> DimType -> Bool
hasTupleId map typ =
    let !r = unsafePerformIO $ M.toBool <$> c_hasTupleId map typ in r


foreign import ccall "isl_map_has_tuple_name" c_hasTupleName :: MapRef s_map -> DimType -> IO C.CBool

hasTupleName :: MapRef s_map -> DimType -> Bool
hasTupleName map typ =
    let !r = unsafePerformIO $ M.toBool <$> c_hasTupleName map typ in r


foreign import ccall "isl_map_is_identity" c_isIdentity :: MapRef s_map -> IO C.CBool

isIdentity :: MapRef s_map -> Bool
isIdentity map =
    let !r = unsafePerformIO $ M.toBool <$> c_isIdentity map in r


foreign import ccall "isl_map_is_product" c_isProduct :: MapRef s_map -> IO C.CBool

isProduct :: MapRef s_map -> Bool
isProduct map =
    let !r = unsafePerformIO $ M.toBool <$> c_isProduct map in r


foreign import ccall "isl_map_is_translation" c_isTranslation :: MapRef s_map -> IO C.CBool

isTranslation :: MapRef s_map -> Bool
isTranslation map =
    let !r = unsafePerformIO $ M.toBool <$> c_isTranslation map in r


foreign import ccall "isl_map_plain_is_empty" c_plainIsEmpty :: MapRef s_map -> IO C.CBool

plainIsEmpty :: MapRef s_map -> Bool
plainIsEmpty map =
    let !r = unsafePerformIO $ M.toBool <$> c_plainIsEmpty map in r


foreign import ccall "isl_map_plain_is_equal" c_plainIsEqual :: MapRef s_map1 -> MapRef s_map2 -> IO C.CBool

plainIsEqual :: MapRef s_map1 -> MapRef s_map2 -> Bool
plainIsEqual map1 map2 =
    let !r = unsafePerformIO $ M.toBool <$> c_plainIsEqual map1 map2 in r


foreign import ccall "isl_map_plain_is_injective" c_plainIsInjective :: MapRef s_map -> IO C.CBool

plainIsInjective :: MapRef s_map -> Bool
plainIsInjective map =
    let !r = unsafePerformIO $ M.toBool <$> c_plainIsInjective map in r


foreign import ccall "isl_map_plain_is_single_valued" c_plainIsSingleValued :: MapRef s_map -> IO C.CBool

plainIsSingleValued :: MapRef s_map -> Bool
plainIsSingleValued map =
    let !r = unsafePerformIO $ M.toBool <$> c_plainIsSingleValued map in r


foreign import ccall "isl_map_plain_is_universe" c_plainIsUniverse :: MapRef s_map -> IO C.CBool

plainIsUniverse :: MapRef s_map -> Bool
plainIsUniverse map =
    let !r = unsafePerformIO $ M.toBool <$> c_plainIsUniverse map in r


foreign import ccall "isl_map_range_is_wrapping" c_rangeIsWrapping :: MapRef s_map -> IO C.CBool

rangeIsWrapping :: MapRef s_map -> Bool
rangeIsWrapping map =
    let !r = unsafePerformIO $ M.toBool <$> c_rangeIsWrapping map in r


foreign import ccall "isl_map_add_constraint" c_addConstraint :: Map -> Constraint -> IO Map

addConstraint :: forall m s_map s_constraint. MonadIO m => Map %1 -> Constraint %1 -> IslT m Map
...
addDims :: forall m s_map. MonadIO m => Map %1 -> DimType -> Int -> IslT m Map
...
alignParams :: forall m s_map s_model. MonadIO m => Map %1 -> Space %1 -> IslT m Map
...
computeDivs :: forall m s_map. MonadIO m => Map %1 -> IslT m Map
...
deltasMap :: forall m s_map. MonadIO m => Map %1 -> IslT m Map
...
domainMap :: forall m s_map. MonadIO m => Map %1 -> IslT m Map
...
dropConstraintsInvolvingDims :: forall m s_map. MonadIO m => Map %1 -> DimType -> Int -> Int -> IslT m Map
...
dropConstraintsNotInvolvingDims :: forall m s_map. MonadIO m => Map %1 -> DimType -> Int -> Int -> IslT m Map
...
eliminate :: forall m s_map. MonadIO m => Map %1 -> DimType -> Int -> Int -> IslT m Map
...
equate :: forall m s_map. MonadIO m => Map %1 -> DimType -> Int -> DimType -> Int -> IslT m Map
...
fixInputSi :: forall m s_map. MonadIO m => Map %1 -> Int -> Int -> IslT m Map
...
fixSi :: forall m s_map. MonadIO m => Map %1 -> DimType -> Int -> Int -> IslT m Map
...
fixVal :: forall m s_map s_v. MonadIO m => Map %1 -> DimType -> Int -> Val %1 -> IslT m Map
...
fixedPowerVal :: forall m s_map s_exp. MonadIO m => Map %1 -> Val %1 -> IslT m Map
...
flatDomainProduct :: forall m s_map1 s_map2. MonadIO m => Map %1 -> Map %1 -> IslT m Map
...
flatProduct :: forall m s_map1 s_map2. MonadIO m => Map %1 -> Map %1 -> IslT m Map
...
flatRangeProduct :: forall m s_map1 s_map2. MonadIO m => Map %1 -> Map %1 -> IslT m Map
...
floordivVal :: forall m s_map s_d. MonadIO m => Map %1 -> Val %1 -> IslT m Map
...
fromAff :: forall m s_aff. MonadIO m => Aff %1 -> IslT m Map
...
fromDomain :: forall m s_set. MonadIO m => Set %1 -> IslT m Map
...
fromDomainAndRange :: forall m s_domain s_range. MonadIO m => Set %1 -> Set %1 -> IslT m Map
...
fromMultiAff :: forall m s_maff. MonadIO m => MultiAff %1 -> IslT m Map
...
fromPwAff :: forall m s_pwaff. MonadIO m => PwAff %1 -> IslT m Map
...
fromPwMultiAff :: forall m s_pma. MonadIO m => PwMultiAff %1 -> IslT m Map
...
fromRange :: forall m s_set. MonadIO m => Set %1 -> IslT m Map
...
fromUnionMap :: forall m s_umap. MonadIO m => UnionMap %1 -> IslT m Map
...
gistBasicMap :: forall m s_map s_context. MonadIO m => Map %1 -> BasicMap %1 -> IslT m Map
...
gistRange :: forall m s_map s_context. MonadIO m => Map %1 -> Set %1 -> IslT m Map
...
identity :: forall m s_space. MonadIO m => Space %1 -> IslT m Map
...
insertDims :: forall m s_map. MonadIO m => Map %1 -> DimType -> Int -> Int -> IslT m Map
...
lexGe :: forall m s_set_space. MonadIO m => Space %1 -> IslT m Map
...
lexGeFirst :: forall m s_space. MonadIO m => Space %1 -> Int -> IslT m Map
...
lexGeMap :: forall m s_map1 s_map2. MonadIO m => Map %1 -> Map %1 -> IslT m Map
...
lexGt :: forall m s_set_space. MonadIO m => Space %1 -> IslT m Map
...
lexGtFirst :: forall m s_space. MonadIO m => Space %1 -> Int -> IslT m Map
...
lexGtMap :: forall m s_map1 s_map2. MonadIO m => Map %1 -> Map %1 -> IslT m Map
...
lexLe :: forall m s_set_space. MonadIO m => Space %1 -> IslT m Map
...
lexLeFirst :: forall m s_space. MonadIO m => Space %1 -> Int -> IslT m Map
...
lexLeMap :: forall m s_map1 s_map2. MonadIO m => Map %1 -> Map %1 -> IslT m Map
...
lexLt :: forall m s_set_space. MonadIO m => Space %1 -> IslT m Map
...
lexLtFirst :: forall m s_space. MonadIO m => Space %1 -> Int -> IslT m Map
...
lexLtMap :: forall m s_map1 s_map2. MonadIO m => Map %1 -> Map %1 -> IslT m Map
...
lowerBoundSi :: forall m s_map. MonadIO m => Map %1 -> DimType -> Int -> Int -> IslT m Map
...
lowerBoundVal :: forall m s_map s_value. MonadIO m => Map %1 -> DimType -> Int -> Val %1 -> IslT m Map
...
makeDisjoint :: forall m s_map. MonadIO m => Map %1 -> IslT m Map
...
moveDims :: forall m s_map. MonadIO m => Map %1 -> DimType -> Int -> DimType -> Int -> Int -> IslT m Map
...
natUniverse :: forall m s_space. MonadIO m => Space %1 -> IslT m Map
...
neg :: forall m s_map. MonadIO m => Map %1 -> IslT m Map
...
oppose :: forall m s_map. MonadIO m => Map %1 -> DimType -> Int -> DimType -> Int -> IslT m Map
...
orderGe :: forall m s_map. MonadIO m => Map %1 -> DimType -> Int -> DimType -> Int -> IslT m Map
...
orderGt :: forall m s_map. MonadIO m => Map %1 -> DimType -> Int -> DimType -> Int -> IslT m Map
...
orderLe :: forall m s_map. MonadIO m => Map %1 -> DimType -> Int -> DimType -> Int -> IslT m Map
...
orderLt :: forall m s_map. MonadIO m => Map %1 -> DimType -> Int -> DimType -> Int -> IslT m Map
...
preimageDomainMultiAff :: forall m s_map s_ma. MonadIO m => Map %1 -> MultiAff %1 -> IslT m Map
...
preimageDomainPwMultiAff :: forall m s_map s_pma. MonadIO m => Map %1 -> PwMultiAff %1 -> IslT m Map
...
preimageRangeMultiAff :: forall m s_map s_ma. MonadIO m => Map %1 -> MultiAff %1 -> IslT m Map
...
preimageRangePwMultiAff :: forall m s_map s_pma. MonadIO m => Map %1 -> PwMultiAff %1 -> IslT m Map
...
projectOut :: forall m s_map. MonadIO m => Map %1 -> DimType -> Int -> Int -> IslT m Map
...
projectOutParamId :: forall m s_map s_id. MonadIO m => Map %1 -> Id %1 -> IslT m Map
...
rangeCurry :: forall m s_map. MonadIO m => Map %1 -> IslT m Map
...
rangeMap :: forall m s_map. MonadIO m => Map %1 -> IslT m Map
...
removeDims :: forall m s_map. MonadIO m => Map %1 -> DimType -> Int -> Int -> IslT m Map
...
removeDivs :: forall m s_map. MonadIO m => Map %1 -> IslT m Map
...
removeDivsInvolvingDims :: forall m s_map. MonadIO m => Map %1 -> DimType -> Int -> Int -> IslT m Map
...
removeInputs :: forall m s_map. MonadIO m => Map %1 -> Int -> Int -> IslT m Map
...
removeRedundancies :: forall m s_map. MonadIO m => Map %1 -> IslT m Map
...
removeUnknownDivs :: forall m s_map. MonadIO m => Map %1 -> IslT m Map
...
resetTupleId :: forall m s_map. MonadIO m => Map %1 -> DimType -> IslT m Map
...
resetUser :: forall m s_map. MonadIO m => Map %1 -> IslT m Map
...
setDimId :: forall m s_map s_id. MonadIO m => Map %1 -> DimType -> Int -> Id %1 -> IslT m Map
...
setDimName :: forall m s_map. MonadIO m => Map %1 -> DimType -> Int -> String -> IslT m Map
...
setDomainTupleId :: forall m s_map s_id. MonadIO m => Map %1 -> Id %1 -> IslT m Map
...
setRangeTupleId :: forall m s_map s_id. MonadIO m => Map %1 -> Id %1 -> IslT m Map
...
setTupleId :: forall m s_map s_id. MonadIO m => Map %1 -> DimType -> Id %1 -> IslT m Map
...
setTupleName :: forall m s_map. MonadIO m => Map %1 -> DimType -> String -> IslT m Map
...
subtractDomain :: forall m s_map s_dom. MonadIO m => Map %1 -> Set %1 -> IslT m Map
...
subtractRange :: forall m s_map s_dom. MonadIO m => Map %1 -> Set %1 -> IslT m Map
...
sum :: forall m s_map1 s_map2. MonadIO m => Map %1 -> Map %1 -> IslT m Map
...
unionDisjoint :: forall m s_map1 s_map2. MonadIO m => Map %1 -> Map %1 -> IslT m Map
...
upperBoundSi :: forall m s_map. MonadIO m => Map %1 -> DimType -> Int -> Int -> IslT m Map
...
upperBoundVal :: forall m s_map s_value. MonadIO m => Map %1 -> DimType -> Int -> Val %1 -> IslT m Map
...
convexHull :: forall m s_map. MonadIO m => Map %1 -> IslT m BasicMap
...
plainUnshiftedSimpleHull :: forall m s_map. MonadIO m => Map %1 -> IslT m BasicMap
...
simpleHull :: forall m s_map. MonadIO m => Map %1 -> IslT m BasicMap
...
foreign import ccall "isl_map_plain_get_val_if_fixed" c_plainGetValIfFixed :: MapRef s_map -> DimType -> C.CUInt -> IO Val

plainGetValIfFixed :: MonadIO m => MapRef s_map -> DimType -> Int -> IslT m Val
...
dimMax :: forall m s_map. MonadIO m => Map %1 -> Int -> IslT m PwAff
...
dimMin :: forall m s_map. MonadIO m => Map %1 -> Int -> IslT m PwAff
...
foreign import ccall "isl_map_get_dim_id" c_getDimId :: MapRef s_map -> DimType -> C.CUInt -> IO Id

getDimId :: MonadIO m => MapRef s_map -> DimType -> Int -> IslT m Id
getDimId map typ pos =
    unsafeIslFromIO $ \_ -> c_getDimId map typ (fromIntegral pos)


foreign import ccall "isl_map_get_tuple_id" c_getTupleId :: MapRef s_map -> DimType -> IO Id

getTupleId :: MonadIO m => MapRef s_map -> DimType -> IslT m Id
getTupleId map typ =
    unsafeIslFromIO $ \_ -> c_getTupleId map typ


foreign import ccall "isl_map_to_str" c_toStr :: MapRef s_map -> IO C.CString

toStr :: MapRef s_map -> String
toStr map =
    let !r = unsafePerformIO $ C.peekCString =<< c_toStr map in r


foreign import ccall "isl_map_domain_tuple_dim" c_domainTupleDim :: MapRef s_map -> IO C.CInt

domainTupleDim :: MapRef s_map -> Int
domainTupleDim map =
    let !r = unsafePerformIO $ fromIntegral <$> c_domainTupleDim map in r


foreign import ccall "isl_map_n_basic_map" c_nBasicMap :: MapRef s_map -> IO C.CInt

nBasicMap :: MapRef s_map -> Int
nBasicMap map =
    let !r = unsafePerformIO $ fromIntegral <$> c_nBasicMap map in r


foreign import ccall "isl_map_range_tuple_dim" c_rangeTupleDim :: MapRef s_map -> IO C.CInt

rangeTupleDim :: MapRef s_map -> Int
rangeTupleDim map =
    let !r = unsafePerformIO $ fromIntegral <$> c_rangeTupleDim map in r


foreign import ccall "isl_map_has_domain_tuple_id" c_hasDomainTupleId :: MapRef s_map -> IO C.CBool

hasDomainTupleId :: MapRef s_map -> Bool
hasDomainTupleId map =
    let !r = unsafePerformIO $ M.toBool <$> c_hasDomainTupleId map in r


foreign import ccall "isl_map_has_range_tuple_id" c_hasRangeTupleId :: MapRef s_map -> IO C.CBool

hasRangeTupleId :: MapRef s_map -> Bool
hasRangeTupleId map =
    let !r = unsafePerformIO $ M.toBool <$> c_hasRangeTupleId map in r


foreign import ccall "isl_map_is_bijective" c_isBijective :: MapRef s_map -> IO C.CBool

isBijective :: MapRef s_map -> Bool
isBijective map =
    let !r = unsafePerformIO $ M.toBool <$> c_isBijective map in r


foreign import ccall "isl_map_is_disjoint" c_isDisjoint :: MapRef s_map1 -> MapRef s_map2 -> IO C.CBool

isDisjoint :: MapRef s_map1 -> MapRef s_map2 -> Bool
isDisjoint map1 map2 =
    let !r = unsafePerformIO $ M.toBool <$> c_isDisjoint map1 map2 in r


foreign import ccall "isl_map_is_empty" c_isEmpty :: MapRef s_map -> IO C.CBool

isEmpty :: MapRef s_map -> Bool
isEmpty map =
    let !r = unsafePerformIO $ M.toBool <$> c_isEmpty map in r


foreign import ccall "isl_map_is_equal" c_isEqual :: MapRef s_map1 -> MapRef s_map2 -> IO C.CBool

isEqual :: MapRef s_map1 -> MapRef s_map2 -> Bool
isEqual map1 map2 =
    let !r = unsafePerformIO $ M.toBool <$> c_isEqual map1 map2 in r


foreign import ccall "isl_map_is_injective" c_isInjective :: MapRef s_map -> IO C.CBool

isInjective :: MapRef s_map -> Bool
isInjective map =
    let !r = unsafePerformIO $ M.toBool <$> c_isInjective map in r


foreign import ccall "isl_map_is_single_valued" c_isSingleValued :: MapRef s_map -> IO C.CBool

isSingleValued :: MapRef s_map -> Bool
isSingleValued map =
    let !r = unsafePerformIO $ M.toBool <$> c_isSingleValued map in r


foreign import ccall "isl_map_is_strict_subset" c_isStrictSubset :: MapRef s_map1 -> MapRef s_map2 -> IO C.CBool

isStrictSubset :: MapRef s_map1 -> MapRef s_map2 -> Bool
isStrictSubset map1 map2 =
    let !r = unsafePerformIO $ M.toBool <$> c_isStrictSubset map1 map2 in r


foreign import ccall "isl_map_is_subset" c_isSubset :: MapRef s_map1 -> MapRef s_map2 -> IO C.CBool

isSubset :: MapRef s_map1 -> MapRef s_map2 -> Bool
isSubset map1 map2 =
    let !r = unsafePerformIO $ M.toBool <$> c_isSubset map1 map2 in r


foreign import ccall "isl_map_deltas" c_deltas :: Map -> IO Set

deltas :: forall m s_map. MonadIO m => Map %1 -> IslT m Set
...
domain :: forall m s_bmap. MonadIO m => Map %1 -> IslT m Set
...
params :: forall m s_map. MonadIO m => Map %1 -> IslT m Set
...
range :: forall m s_map. MonadIO m => Map %1 -> IslT m Set
...
wrap :: forall m s_map. MonadIO m => Map %1 -> IslT m Set
...
foreign import ccall "isl_map_get_space" c_getSpace :: MapRef s_map -> IO Space

getSpace :: MonadIO m => MapRef s_map -> IslT m Space
getSpace map =
...
applyDomain :: forall m s_map1 s_map2. MonadIO m => Map %1 -> Map %1 -> IslT m Map
...
applyRange :: forall m s_map1 s_map2. MonadIO m => Map %1 -> Map %1 -> IslT m Map
...
coalesce :: forall m s_map. MonadIO m => Map %1 -> IslT m Map
...
complement :: forall m s_map. MonadIO m => Map %1 -> IslT m Map
...
curry :: forall m s_map. MonadIO m => Map %1 -> IslT m Map
...
detectEqualities :: forall m s_map. MonadIO m => Map %1 -> IslT m Map
...
domainFactorDomain :: forall m s_map. MonadIO m => Map %1 -> IslT m Map
...
domainFactorRange :: forall m s_map. MonadIO m => Map %1 -> IslT m Map
...
domainProduct :: forall m s_map1 s_map2. MonadIO m => Map %1 -> Map %1 -> IslT m Map
...
domainReverse :: forall m s_map. MonadIO m => Map %1 -> IslT m Map
...
dropUnusedParams :: forall m s_map. MonadIO m => Map %1 -> IslT m Map
...
empty :: forall m s_space. MonadIO m => Space %1 -> IslT m Map
...
factorDomain :: forall m s_map. MonadIO m => Map %1 -> IslT m Map
...
factorRange :: forall m s_map. MonadIO m => Map %1 -> IslT m Map
...
flatten :: forall m s_map. MonadIO m => Map %1 -> IslT m Map
...
flattenDomain :: forall m s_map. MonadIO m => Map %1 -> IslT m Map
...
flattenRange :: forall m s_map. MonadIO m => Map %1 -> IslT m Map
...
gist :: forall m s_map s_context. MonadIO m => Map %1 -> Map %1 -> IslT m Map
...
gistDomain :: forall m s_map s_context. MonadIO m => Map %1 -> Set %1 -> IslT m Map
...
gistParams :: forall m s_map s_context. MonadIO m => Map %1 -> Set %1 -> IslT m Map
...
intersect :: forall m s_map1 s_map2. MonadIO m => Map %1 -> Map %1 -> IslT m Map
...
intersectDomain :: forall m s_map s_set. MonadIO m => Map %1 -> Set %1 -> IslT m Map
...
intersectDomainFactorDomain :: forall m s_map s_factor. MonadIO m => Map %1 -> Map %1 -> IslT m Map
...
intersectDomainFactorRange :: forall m s_map s_factor. MonadIO m => Map %1 -> Map %1 -> IslT m Map
...
intersectDomainWrappedDomain :: forall m s_map s_domain. MonadIO m => Map %1 -> Set %1 -> IslT m Map
...
intersectParams :: forall m s_map s_params. MonadIO m => Map %1 -> Set %1 -> IslT m Map
...
intersectRange :: forall m s_map s_set. MonadIO m => Map %1 -> Set %1 -> IslT m Map
...
intersectRangeFactorDomain :: forall m s_map s_factor. MonadIO m => Map %1 -> Map %1 -> IslT m Map
...
intersectRangeFactorRange :: forall m s_map s_factor. MonadIO m => Map %1 -> Map %1 -> IslT m Map
...
intersectRangeWrappedDomain :: forall m s_map s_domain. MonadIO m => Map %1 -> Set %1 -> IslT m Map
...
lexmax :: forall m s_map. MonadIO m => Map %1 -> IslT m Map
...
lexmin :: forall m s_map. MonadIO m => Map %1 -> IslT m Map
...
product :: forall m s_map1 s_map2. MonadIO m => Map %1 -> Map %1 -> IslT m Map
...
projectOutAllParams :: forall m s_map. MonadIO m => Map %1 -> IslT m Map
...
rangeFactorDomain :: forall m s_map. MonadIO m => Map %1 -> IslT m Map
...
rangeFactorRange :: forall m s_map. MonadIO m => Map %1 -> IslT m Map
...
rangeProduct :: forall m s_map1 s_map2. MonadIO m => Map %1 -> Map %1 -> IslT m Map
...
rangeReverse :: forall m s_map. MonadIO m => Map %1 -> IslT m Map
...
reverse :: forall m s_map. MonadIO m => Map %1 -> IslT m Map
...
subtract :: forall m s_map1 s_map2. MonadIO m => Map %1 -> Map %1 -> IslT m Map
...
uncurry :: forall m s_map. MonadIO m => Map %1 -> IslT m Map
...
union :: forall m s_map1 s_map2. MonadIO m => Map %1 -> Map %1 -> IslT m Map
...
universe :: forall m s_space. MonadIO m => Space %1 -> IslT m Map
...
zip :: forall m s_map. MonadIO m => Map %1 -> IslT m Map
...
affineHull :: forall m s_map. MonadIO m => Map %1 -> IslT m BasicMap
...
polyhedralHull :: forall m s_map. MonadIO m => Map %1 -> IslT m BasicMap
...
sample :: forall m s_map. MonadIO m => Map %1 -> IslT m BasicMap
...
unshiftedSimpleHull :: forall m s_map. MonadIO m => Map %1 -> IslT m BasicMap
...
toUnionMap :: forall m s_map. MonadIO m => Map %1 -> IslT m UnionMap
...
asPwMultiAff :: forall m s_map. MonadIO m => Map %1 -> IslT m PwMultiAff
...
lexmaxPwMultiAff :: forall m s_map. MonadIO m => Map %1 -> IslT m PwMultiAff
...
lexminPwMultiAff :: forall m s_map. MonadIO m => Map %1 -> IslT m PwMultiAff
...
foreign import ccall "isl_map_get_domain_tuple_id" c_getDomainTupleId :: MapRef s_map -> IO Id

getDomainTupleId :: MonadIO m => MapRef s_map -> IslT m Id
getDomainTupleId map =
    unsafeIslFromIO $ \_ -> c_getDomainTupleId map


foreign import ccall "isl_map_get_range_tuple_id" c_getRangeTupleId :: MapRef s_map -> IO Id

getRangeTupleId :: MonadIO m => MapRef s_map -> IslT m Id
getRangeTupleId map =
...
fromBasicMap :: forall m s_bmap. MonadIO m => BasicMap %1 -> IslT m Map
