...
contains uset space =
    unsafePerformIO $ fromIntegral <$> c_contains uset space
...
dim uset typ =
    unsafePerformIO $ fromIntegral <$> c_dim uset typ
...
nSet uset =
    unsafePerformIO $ fromIntegral <$> c_nSet uset
...
isParams uset =
    unsafePerformIO $ M.toBool <$> c_isParams uset
...
toStr uset =
    unsafePerformIO $ C.peekCString =<< c_toStr uset
...
isaSet uset =
    unsafePerformIO $ fromIntegral <$> c_isaSet uset
...
isDisjoint uset1 uset2 =
    unsafePerformIO $ M.toBool <$> c_isDisjoint uset1 uset2
...
isEmpty uset =
    unsafePerformIO $ M.toBool <$> c_isEmpty uset
...
isEqual uset1 uset2 =
    unsafePerformIO $ M.toBool <$> c_isEqual uset1 uset2
...
isStrictSubset uset1 uset2 =
    unsafePerformIO $ M.toBool <$> c_isStrictSubset uset1 uset2
...
isSubset uset1 uset2 =
    unsafePerformIO $ M.toBool <$> c_isSubset uset1 uset2
