...
eqSi v i =
    unsafePerformIO $ fromIntegral <$> c_eqSi v (fromIntegral i)
...
gtSi v i =
    unsafePerformIO $ fromIntegral <$> c_gtSi v (fromIntegral i)
...
nAbsNumChunks v size =
    unsafePerformIO $ fromIntegral <$> c_nAbsNumChunks v (fromIntegral size)
...
toStr :: ValRef -> String
toStr v =
    unsafePerformIO $ C.peekCString =<< c_toStr v
...
cmpSi v i =
    unsafePerformIO $ fromIntegral <$> c_cmpSi v (fromIntegral i)
...
sgn :: ValRef -> Int
sgn v =
    unsafePerformIO $ fromIntegral <$> c_sgn v
...
getDenSi v =
    unsafePerformIO $ fromIntegral <$> c_getDenSi v
...
getNumSi v =
    unsafePerformIO $ fromIntegral <$> c_getNumSi v
...
absEq v1 v2 =
    unsafePerformIO $ M.toBool <$> c_absEq v1 v2
...
eq v1 v2 =
    unsafePerformIO $ M.toBool <$> c_eq v1 v2
...
ge v1 v2 =
    unsafePerformIO $ M.toBool <$> c_ge v1 v2
...
gt v1 v2 =
    unsafePerformIO $ M.toBool <$> c_gt v1 v2
...
isDivisibleBy v1 v2 =
    unsafePerformIO $ M.toBool <$> c_isDivisibleBy v1 v2
...
isInfty :: ValRef -> Bool
isInfty v =
    unsafePerformIO $ M.toBool <$> c_isInfty v
...
isInt :: ValRef -> Bool
isInt v =
    unsafePerformIO $ M.toBool <$> c_isInt v
...
isNan :: ValRef -> Bool
isNan v =
    unsafePerformIO $ M.toBool <$> c_isNan v
...
isNeg :: ValRef -> Bool
isNeg v =
    unsafePerformIO $ M.toBool <$> c_isNeg v
...
isNeginfty v =
    unsafePerformIO $ M.toBool <$> c_isNeginfty v
...
isNegone v =
    unsafePerformIO $ M.toBool <$> c_isNegone v
...
isNonneg v =
    unsafePerformIO $ M.toBool <$> c_isNonneg v
...
isNonpos v =
    unsafePerformIO $ M.toBool <$> c_isNonpos v
...
isOne :: ValRef -> Bool
isOne v =
    unsafePerformIO $ M.toBool <$> c_isOne v
...
isPos :: ValRef -> Bool
isPos v =
    unsafePerformIO $ M.toBool <$> c_isPos v
...
isRat :: ValRef -> Bool
isRat v =
    unsafePerformIO $ M.toBool <$> c_isRat v
...
isZero :: ValRef -> Bool
isZero v =
    unsafePerformIO $ M.toBool <$> c_isZero v
...
le v1 v2 =
    unsafePerformIO $ M.toBool <$> c_le v1 v2
...
lt v1 v2 =
    unsafePerformIO $ M.toBool <$> c_lt v1 v2
...
ne v1 v2 =
    unsafePerformIO $ M.toBool <$> c_ne v1 v2
